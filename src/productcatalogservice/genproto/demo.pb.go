...
const (
	...
	ErrorCode_PRODUCT_NOT_FOUND              ErrorCode = 1
	ErrorCode_CART_NOT_FOUND                 ErrorCode = 2
	ErrorCode_INVALID_CREDIT_CARD            ErrorCode = 3
	ErrorCode_EXPIRED_CREDIT_CARD            ErrorCode = 4
	ErrorCode_UNACCEPTED_CREDIT_CARD         ErrorCode = 5
	ErrorCode_INVALID_CURRENCY               ErrorCode = 6
	ErrorCode_INVALID_REQUEST                ErrorCode = 7
	ErrorCode_STORAGE_UNAVAILABLE            ErrorCode = 8
	ErrorCode_DOWNSTREAM_SERVICE_UNAVAILABLE ErrorCode = 9
	ErrorCode_PAYMENT_FAILED                 ErrorCode = 10
	ErrorCode_SHIPPING_FAILED                ErrorCode = 11
	ErrorCode_EMAIL_DELIVERY_FAILED          ErrorCode = 12
)
...
var (
	ErrorCode_name = map[int32]string{
		...
		1:  "PRODUCT_NOT_FOUND",
		2:  "CART_NOT_FOUND",
		3:  "INVALID_CREDIT_CARD",
		4:  "EXPIRED_CREDIT_CARD",
		5:  "UNACCEPTED_CREDIT_CARD",
		6:  "INVALID_CURRENCY",
		7:  "INVALID_REQUEST",
		8:  "STORAGE_UNAVAILABLE",
		9:  "DOWNSTREAM_SERVICE_UNAVAILABLE",
		10: "PAYMENT_FAILED",
		11: "SHIPPING_FAILED",
		12: "EMAIL_DELIVERY_FAILED",
	}
...
type ServiceError struct {
	...
	ErrorCode     ErrorCode              `protobuf:"varint,1,opt,name=error_code,json=errorCode,proto3,enum=hipstershop.ErrorCode" json:"error_code,omitempty"`
...
func (x *ServiceError) GetOriginService() string {
	if x != nil {
...
const file_demo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"demo.proto\x12\vhipstershop\"\x86\x01\n" +
	"\fServiceError\x125\n" +
	"\n" +
	"error_code\x18\x01 \x01(\x0e2\x16.hipstershop.ErrorCodeR\terrorCode\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12%\n" +
	"\x0eorigin_service\x18\x03 \x01(\tR\roriginService\"E\n" +
	"\bCartItem\x12\x1d\n" +
	"\n" +
	...
	"\x04text\x18\x02 \x01(\tR\x04text*\xcc\x02\n" +
	"\tErrorCode\x12\x1a\n" +
	"\x16ERROR_CODE_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11PRODUCT_NOT_FOUND\x10\x01\x12\x12\n" +
	"\x0eCART_NOT_FOUND\x10\x02\x12\x17\n" +
	"\x13INVALID_CREDIT_CARD\x10\x03\x12\x17\n" +
	"\x13EXPIRED_CREDIT_CARD\x10\x04\x12\x1a\n" +
	"\x16UNACCEPTED_CREDIT_CARD\x10\x05\x12\x14\n" +
	"\x10INVALID_CURRENCY\x10\x06\x12\x13\n" +
	"\x0fINVALID_REQUEST\x10\a\x12\x17\n" +
	"\x13STORAGE_UNAVAILABLE\x10\b\x12\"\n" +
	"\x1eDOWNSTREAM_SERVICE_UNAVAILABLE\x10\t\x12\x12\n" +
	"\x0ePAYMENT_FAILED\x10\n" +
	"\x12\x13\n" +
	"\x0fSHIPPING_FAILED\x10\v\x12\x19\n" +
	"\x15EMAIL_DELIVERY_FAILED\x10\f2\xca\x01\n" +
	"\vCartService\x12<\n" +
...
var file_demo_proto_goTypes = []any{
	(ErrorCode)(0),                         // 0: hipstershop.ErrorCode
	(*ServiceError)(nil),                   // 1: hipstershop.ServiceError
...
var file_demo_proto_depIdxs = []int32{
	0,  // 0: hipstershop.ServiceError.error_code:type_name -> hipstershop.ErrorCode
	2,  // 1: hipstershop.AddItemRequest.item:type_name -> hipstershop.CartItem
	2,  // 2: hipstershop.Cart.items:type_name -> hipstershop.CartItem
	20, // 3: hipstershop.Product.price_usd:type_name -> hipstershop.Money
	10, // 4: hipstershop.ListProductsResponse.products:type_name -> hipstershop.Product
	10, // 5: hipstershop.SearchProductsResponse.results:type_name -> hipstershop.Product
	19, // 6: hipstershop.GetQuoteRequest.address:type_name -> hipstershop.Address
	2,  // 7: hipstershop.GetQuoteRequest.items:type_name -> hipstershop.CartItem
	20, // 8: hipstershop.GetQuoteResponse.cost_usd:type_name -> hipstershop.Money
	19, // 9: hipstershop.ShipOrderRequest.address:type_name -> hipstershop.Address
	2,  // 10: hipstershop.ShipOrderRequest.items:type_name -> hipstershop.CartItem
	20, // 11: hipstershop.CurrencyConversionRequest.from:type_name -> hipstershop.Money
	20, // 12: hipstershop.ChargeRequest.amount:type_name -> hipstershop.Money
	23, // 13: hipstershop.ChargeRequest.credit_card:type_name -> hipstershop.CreditCardInfo
	2,  // 14: hipstershop.OrderItem.item:type_name -> hipstershop.CartItem
	20, // 15: hipstershop.OrderItem.cost:type_name -> hipstershop.Money
	20, // 16: hipstershop.OrderResult.shipping_cost:type_name -> hipstershop.Money
	19, // 17: hipstershop.OrderResult.shipping_address:type_name -> hipstershop.Address
	26, // 18: hipstershop.OrderResult.items:type_name -> hipstershop.OrderItem
	27, // 19: hipstershop.SendOrderConfirmationRequest.order:type_name -> hipstershop.OrderResult
	19, // 20: hipstershop.PlaceOrderRequest.address:type_name -> hipstershop.Address
	23, // 21: hipstershop.PlaceOrderRequest.credit_card:type_name -> hipstershop.CreditCardInfo
	27, // 22: hipstershop.PlaceOrderResponse.order:type_name -> hipstershop.OrderResult
	...
	7,  // 39: hipstershop.CartService.AddItem:output_type -> hipstershop.Empty
	6,  // 40: hipstershop.CartService.GetCart:output_type -> hipstershop.Cart
	7,  // 41: hipstershop.CartService.EmptyCart:output_type -> hipstershop.Empty
	9,  // 42: hipstershop.RecommendationService.ListRecommendations:output_type -> hipstershop.ListRecommendationsResponse
	11, // 43: hipstershop.ProductCatalogService.ListProducts:output_type -> hipstershop.ListProductsResponse
	10, // 44: hipstershop.ProductCatalogService.GetProduct:output_type -> hipstershop.Product
	14, // 45: hipstershop.ProductCatalogService.SearchProducts:output_type -> hipstershop.SearchProductsResponse
	16, // 46: hipstershop.ShippingService.GetQuote:output_type -> hipstershop.GetQuoteResponse
	18, // 47: hipstershop.ShippingService.ShipOrder:output_type -> hipstershop.ShipOrderResponse
	21, // 48: hipstershop.CurrencyService.GetSupportedCurrencies:output_type -> hipstershop.GetSupportedCurrenciesResponse
	20, // 49: hipstershop.CurrencyService.Convert:output_type -> hipstershop.Money
	25, // 50: hipstershop.PaymentService.Charge:output_type -> hipstershop.ChargeResponse
	7,  // 51: hipstershop.EmailService.SendOrderConfirmation:output_type -> hipstershop.Empty
	30, // 52: hipstershop.CheckoutService.PlaceOrder:output_type -> hipstershop.PlaceOrderResponse
	32, // 53: hipstershop.AdService.GetAds:output_type -> hipstershop.AdResponse
