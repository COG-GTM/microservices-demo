...
// Standardized application-level error detail attached to gRPC error responses
...
func (x *ServiceError) GetErrorCode() string {
	if x != nil {
		return x.ErrorCode
	}
	return ""
...
func (x *ServiceError) GetFieldViolations() []*FieldViolation {
	if x != nil {
...
const file_demo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"demo.proto\x12\vhipstershop\"\xa9\x01\n" +
	"\fServiceError\x12\x1d\n" +
	"\n" +
	"error_code\x18\x01 \x01(\tR\terrorCode\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x18\n" +
	"\aservice\x18\x03 \x01(\tR\aservice\x12F\n" +
	"\x10field_violations\x18\x04 \x03(\v2\x1b.hipstershop.FieldViolationR\x0ffieldViolations\"H\n" +
...
var file_demo_proto_goTypes = []any{
	(*ServiceError)(nil),                   // 0: hipstershop.ServiceError
	(*FieldViolation)(nil),                 // 1: hipstershop.FieldViolation
...
var file_demo_proto_depIdxs = []int32{
	1,  // 0: hipstershop.ServiceError.field_violations:type_name -> hipstershop.FieldViolation
